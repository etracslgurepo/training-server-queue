...
from (
	...
	from (
			select 
					eor.receiptno,
					eor.receiptdate,
					case when cv.objid is null then eor.amount else 0 end as amount, 
					b.name as barangay,
					rl.tdno,
					rlf.assessedvalue,
